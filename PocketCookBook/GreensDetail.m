...
#import "GreensDetail.h"

@implementation GreensDetail
+(void)getGreensKingById:(NSString *)cbId byBlock:(getDic)block failure:(getErr)errors{
    __block NSDictionary *greens;
    NSString *baseUrl=@"http://route.showapi.com/95-35";
    NSDictionary *dic=@{@"showapi_appid":@"8552",@"showapi_timestamp":[TimeGetter getTimeNow],@"cbId":cbId};
